# music_service/services/token_service.py
...
class TokenService:
    """
    Cliente de tokens para el music_service.
    No refresca tokens directamente con Spotify — esa responsabilidad
    es exclusiva del authentication_service. Aquí solo se consulta
    y se cachea en Redis para no llamar al auth_service en cada request.
    """
